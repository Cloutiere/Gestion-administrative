...
def page_champ(champ_no: str) -> Any:
    """
    Affiche la page détaillée d'un champ spécifique, accessible aux admins ou aux
    utilisateurs ayant la permission explicite.
    """
    ...
    enseignants_du_champ = db.get_enseignants_par_champ(champ_no)
    cours_disponibles_bruts = db.get_cours_disponibles_par_champ(champ_no)
